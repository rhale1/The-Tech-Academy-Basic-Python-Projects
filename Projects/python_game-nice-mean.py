#Python: 3.7.3
#
#Author: Daniel A. Christie //  Rachel Hale 
#
...
def describe_game(name):
    ...
    If it is not a new game, thank the payer for playing again and continue with the game
    """
